...
docker exec -it -w /home/docker av-deamon-builder yumdownloader -x \*i686 --archlist=x86_64 clamav clamav-lib clamav-update json-c pcre2 clamd systemd-libs lz4 procps elfutils-libs
...
docker exec -it -w /home/docker av-deamon-builder /bin/sh -c "rpm2cpio elfutils*.rpm | cpio -idmv"
...
cp -r clamav/usr/sbin/clamd clamav/usr/bin/clamscan clamav/usr/bin/clamdscan clamav/usr/bin/freshclam clamav/usr/lib64/* ./src/* ./node_modules bin/.
